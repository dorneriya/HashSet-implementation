 ...
 * version 1.1
 * <p>
 * You are more then welcome to improve the tester - add hashset.tests, fix bugs, improve the current ones or make
 * the tester more accessible. If you do so, update the changelog below.
 * <p>
 * Changelog:
 * 1.0 - 29/4/18 - Evyatar - Created.
 * 1.1 - 29/4/18 - Evyatar - Add the capacity hashset.tests
 */
...
// יש לנו 12  טסטים -
// טסטים (1-4) למחלקה hashset.OpenHashSet
// טסטים (5-8) למחלקה ClosednHashSet
// טסטים (9-12) למחלקה hashset.CollectionFacadeSet
...
// * שימו לב שהטסטר לא בודק את המחלקה hashset.SimpleSetPerformanceAnalyzer.
...
public class EvyatarTest {
	...
	// ----------------------openHashSet hashset.tests---------------------------

	/**
	 * call the function sanityTest 3 times, each time with a hashset.OpenHashSet with a different constructor.
	 * see sanityTest doc.
	 */
	@Test
	...
	/**
	 * call the function aLotOfStrings_test 3 times, each time with a hashset.OpenHashSet with a different constructor.
	...
	// ----------------------closedHashSet hashset.tests---------------------------

	/**
	 * call the function sanityTest 3 times, each time with a hashset.ClosedHashSet with a different constructor.
	 * see sanityTest doc.
	 */
	@Test
	...
	/**
	 * call the function aLotOfStrings_test 3 times, each time with a hashset.ClosedHashSet with a different constructor.
	 * see aLotOfStrings_test doc
	 */
	@Test
	...
	// ----------------------facade hashset.tests---------------------------

	/**
	 * call the function sanityTest 3 times, each time with a hashset.CollectionFacadeSet with a different type of
	 * collections.
	 * see sanityTest doc.
	 */
	@Test
	...
	/**
	 * call the function aLotOfStrings_test 3 times, each time with a hashset.CollectionFacadeSet with a different type of
	 * collections.
	 * see aLotOfStrings_test doc
	 */
	@Test
	...
	/**
	 * call the function random_one_by_one 3 times, each time with a hashset.CollectionFacadeSet with a different type of
	 * collections.
	 * see there docs.
	 */
	@Test
	...
	/**
	 * call the function random_insert_in_constructor 3 times, each time with a hashset.CollectionFacadeSet with a
	...
	/*
	simple test for the given hashset.SimpleSet, add one string, remove it, ....
	 */
	...
	/*
	add 1000 strings to the given hashset.SimpleSet and then remove them. the strings are "1", "2", "3"....
	 */
...
//		iterations = 100;
	...
	/*
	add 1000 strings to the given hashset.SimpleHashSet and then remove them. check if the capacity is as expected.
	 */
	...
	/*
	add 1000 strings to the given hashset.SimpleSet and then remove them. the strings are generated randomly.
	...
	private void random_one_by_one(SimpleSet myHashSet) {
		...
		HashSet<String> classicSet = new HashSet<String>();
	...
	/*
	add 1000 strings to the given hashset.SimpleSet in the constructor, and then remove them one by one. the strings
	...
	private void random_insert_in_constructor(int typeOfSet) {
		...
		// a regular HashSet (implemented by java) to compare wish "myHashSet".
		HashSet<String> classicSet = new HashSet<String>(Arrays.asList(randomStrings));
		...
		switch (typeOfSet) {
			...
			case 1:
				...
				break;
			case 2:
				myHashSet = new CollectionFacadeSet(new LinkedList<String>(Arrays.asList(randomStrings)));
				break;
			case 3:
				myHashSet = new CollectionFacadeSet(new TreeSet<String>(Arrays.asList(randomStrings)));
				break;
			case 4:
				myHashSet = new CollectionFacadeSet(new HashSet<String>(Arrays.asList(randomStrings)));
				break;
			default:
				myHashSet = null;
				fail();
	...
	private String[] generateRandomStrings(int numOfStrings, boolean shouldAvoidDuplicates) {
		...
		Set<String> randomStringsSet = new HashSet<String>();
		String toAdd;
		for (int i = 0; i < numOfStrings; i++) {
			do {
